...
$$
U = \begin{pmatrix} p\\u \end{pmatrix}
\qquad
F(U) = \begin{pmatrix} u_0 & \rho_0 c^2 \\ \frac{1}{\rho_0} & u_0 \end{pmatrix} U
\qquad
S(U) = \begin{pmatrix} 0\\0 \end{pmatrix}
$$
...
U = \begin{pmatrix} p\\u \end{pmatrix}
\qquad
F(U) = \begin{pmatrix} u_0 & \rho_0 \\ c^2 & u_0 \end{pmatrix} U
\qquad
S(U) = \begin{pmatrix} 0\\0 \end{pmatrix}
$$
with EOS $p(\rho) = \rho c^2$ where $c$ is the speed of sound.
...
\qquad
F(U) = \begin{pmatrix} hu \\ hu^2 + \frac{gh^2}{2} \end{pmatrix}
\qquad
S(U) = \begin{pmatrix} 0\\ -gh\partial_x z \end{pmatrix}
$$
...
\qquad
F(U) = \begin{pmatrix} \rho u \\ \rho u^2 + p \end{pmatrix}
\qquad
S(U) = \begin{pmatrix} 0\\ 0 \end{pmatrix}
$$
...
$$
U = \begin{pmatrix} \rho \\ \rho u \\ \epsilon \end{pmatrix}
\qquad
F(U) = \begin{pmatrix} \rho u \\ \rho u^2 + p \\ u(\epsilon + p) \end{pmatrix}
\qquad
S(U) = \begin{pmatrix} 0\\ 0 \end{pmatrix}
$$
