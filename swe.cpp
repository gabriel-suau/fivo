...
int main() {
  ...
  auto left_bc = fivo::SWE::BCWall::make();
  auto right_bc = fivo::SWE::BCWall::make();

  // Friction model
  auto friction_model = fivo::SWE::ManningFriction::make(0.04);
  ...
  system.add_topography(bump, dbump_dx);
